...
agentcoreFeatures:
  - "gateway"
objectives:
  - "Explain agentcore gateway + mcp in production terms"
  - "Relate LangGraph graphs to AgentCore primitives"
  - "Identify where MCP tools attach in the topology"
diagrams:
  - "ac-gateway-mcp"
quiz:
  - q: "What is the primary focus of AgentCore Gateway + MCP?"
    options:
      - "GPU tuning"
...
<Diagram id="ac-gateway-mcp" caption="AgentCore Gateway + MCP architecture." alt="Diagram for AgentCore Gateway + MCP" />
