...
agentcoreFeatures:
  - "runtime"
objectives:
  - "Explain multi-agent systems primer in production terms"
  - "Relate LangGraph graphs to AgentCore primitives"
  - "Identify where MCP tools attach in the topology"
diagrams:
  - "ac-multi-agent-topology"
quiz:
  - q: "What is the primary focus of Multi-Agent Systems Primer?"
    options:
      - "GPU tuning"
...
<Diagram id="ac-multi-agent-topology" caption="Multi-Agent Systems Primer architecture." alt="Diagram for Multi-Agent Systems Primer" />
