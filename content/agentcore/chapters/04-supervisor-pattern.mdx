...
agentcoreFeatures:
  - "runtime"
objectives:
  - "Explain supervisor pattern in langgraph in production terms"
  - "Relate LangGraph graphs to AgentCore primitives"
  - "Identify where MCP tools attach in the topology"
diagrams:
  - "ac-supervisor-routing"
quiz:
  - q: "What is the primary focus of Supervisor Pattern in LangGraph?"
    options:
      - "GPU tuning"
...
<Diagram id="ac-supervisor-routing" caption="Supervisor Pattern in LangGraph architecture." alt="Diagram for Supervisor Pattern in LangGraph" />
