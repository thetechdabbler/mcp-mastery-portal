...
agentcoreFeatures:
  - "identity"
objectives:
  - "Explain agentcore identity in production terms"
  - "Relate LangGraph graphs to AgentCore primitives"
  - "Identify where MCP tools attach in the topology"
diagrams:
  - "ac-identity-delegate"
quiz:
  - q: "What is the primary focus of AgentCore Identity?"
    options:
      - "GPU tuning"
...
<Diagram id="ac-identity-delegate" caption="AgentCore Identity architecture." alt="Diagram for AgentCore Identity" />
