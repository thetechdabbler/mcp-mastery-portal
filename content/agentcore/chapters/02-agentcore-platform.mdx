...
agentcoreFeatures:
  ...
  - "observability"
objectives:
  - "Explain agentcore in one diagram in production terms"
  - "Relate LangGraph graphs to AgentCore primitives"
  - "Identify where MCP tools attach in the topology"
diagrams:
  - "ac-platform-overview"
quiz:
  - q: "What is the primary focus of AgentCore in One Diagram?"
    options:
      - "GPU tuning"
...
<Diagram id="ac-platform-overview" caption="AgentCore in One Diagram architecture." alt="Diagram for AgentCore in One Diagram" />
